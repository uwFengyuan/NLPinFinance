...
def main(args):
    ...
    print('-'*24 + 'Load Vocabulary Wrapper' + '-'*24)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--caption_path', type=str,
                        default='/data/liufengyuan/NLPinFinance/Data_Image/new_data_train.json',
                        help='path for train annotation json file')
    parser.add_argument('--caption_val_path', type=str,
                        default='/data/liufengyuan/NLPinFinance/Data_Image/new_data_val.json',
